...
namespace ASN.Models
{
    ...
    public partial class ASNContext : DbContext
    {
        ...
        public virtual ObjectResult<string> CatRelUserRoleSel(Nullable<int> cCMSID)
        {
            var cCMSIDParameter = cCMSID.HasValue ?
                new ObjectParameter("CCMSID", cCMSID) :
                new ObjectParameter("CCMSID", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<string>("CatRelUserRoleSel", cCMSIDParameter);
        }
