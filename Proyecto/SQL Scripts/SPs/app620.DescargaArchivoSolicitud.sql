...
AS
	BEGIN
		...
		FROM	[app620].[CatSolicitudes] S
				...
				LEFT JOIN [Mty1vacd-01].CCMS.dbo.TPNSR_CCMS_EmployeePlus E ON E.Ident = EMS.[Empleado_Ident]
				INNER JOIN [Mty1vacd-01].CCMS.XMLRPC.LocationBuildLocation AS b ON E.Location_Ident = b.ident
