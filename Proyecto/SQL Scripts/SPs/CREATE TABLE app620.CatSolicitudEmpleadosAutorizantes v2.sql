...
ALTER TABLE [app620].[CatSolicitudEmpleadosAutorizantes] DROP CONSTRAINT [DF_CatSolicitudEmpleadosAutorizantes_LastModifiedFromPCName]
GO

ALTER TABLE [app620].[CatSolicitudEmpleadosAutorizantes] DROP CONSTRAINT [DF_CatSolicitudEmpleadosAutorizantes_LastModifiedDate]
GO

ALTER TABLE [app620].[CatSolicitudEmpleadosAutorizantes] DROP CONSTRAINT [DF_CatSolicitudEmpleadosAutorizantes_LastModifiedBy]
GO

ALTER TABLE [app620].[CatSolicitudEmpleadosAutorizantes] DROP CONSTRAINT [DF_CatSolicitudEmpleadosAutorizantes_CreatedDate]
GO

ALTER TABLE [app620].[CatSolicitudEmpleadosAutorizantes] DROP CONSTRAINT [DF_CatSolicitudEmpleadosAutorizantes_CreatedBy]
GO

ALTER TABLE [app620].[CatSolicitudEmpleadosAutorizantes] DROP CONSTRAINT [DF_CatSolicitudEmpleadosAutorizantes_Active]
GO

/****** Object:  Table [app620].[CatSolicitudEmpleadosAutorizantes]    Script Date: 02/07/2019 10:30:15 a. m. ******/
DROP TABLE [app620].[CatSolicitudEmpleadosAutorizantes]
GO
